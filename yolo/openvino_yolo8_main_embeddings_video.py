...
# Number of samples to take during video enrollment (this is now controlled in the function)
# RECORD_DURATION = 7.0 # (Moved inside the enrollment function)
...
# ---
# --- NEW FUNCTION: FACE ENROLLMENT (VIDEO RECORDING) ---
# ---
def run_face_enrollment_video(compiled_model_rec, face_cascade, known_faces_db_video):
    ...
    RECORD_DURATION = 15.0 # Record for 15 seconds
    FRAMES_TO_SKIP_FOR_EMBEDDING = 3 # Grab an embedding every 5 frames
    # ---
        ...
        if frame_count % FRAMES_TO_SKIP_FOR_EMBEDDING == 0:
            ...
            if len(faces) > 0:
                ...
                if preprocessed_face is not None:
                    # Use the main inference function
                    ...
                    if result is not None:
                        ...
                        # Draw a green box to show a successful capture
