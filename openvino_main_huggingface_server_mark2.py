...
# ---
# --- (MODE 2) MAIN FUNCTION: SERVER PROCESSING LOOP ---
# ---
def run_server_processing(
    ...
    print("[SERVER] Running in server mode.")
    print("[SERVER] Face enrollment must be done by running the script locally (this feature is removed from server-only mode).")
...
if __name__ == "__main__":
    ...
    print("--- Initializing Smart Glasses (SERVER MODE) ---")
